...
class Doctor extends Equatable {
  ...
  @override
  List<Object?> get props => [
        id, name, specialty, about, imageUrl, rating, reviewsCount,
        experienceYears, patientsCount, availableDates, availableTimes,
        clinicAddress, consultationFee, location, price, workingHours,
      ];
}
...
class FakeDoctors {
  ...
  static final List<Doctor> doctors = [
    Doctor(
      ...
      imageUrl: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2',
      rating: 4.9, reviewsCount: 312, experienceYears: 12, patientsCount: 2400,
      price: 500, location: 'Downtown Medical Center',
      clinicAddress: 'Downtown Medical Center', consultationFee: 120,
      availableDates: _dates, availableTimes: _times, workingHours: _workingHours,
    ),
    Doctor(
      id: '2', name: 'Dr. Michael Brown', specialty: 'dentist',
      about: 'Expert dentist providing cosmetic and restorative dental care.',
      imageUrl: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d',
      rating: 4.8, reviewsCount: 189, experienceYears: 9, patientsCount: 1700,
      price: 800, location: 'Alshaalan - hamraa street',
      clinicAddress: 'Smile Dental Clinic', consultationFee: 90,
      availableDates: _dates, availableTimes: _times, workingHours: _workingHours,
    ),
    Doctor(
      id: '3', name: 'Dr. Emily Wilson', specialty: 'neurology',
      about: 'Neurologist focused on brain and nervous system disorders.',
      imageUrl: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f',
      rating: 4.7, reviewsCount: 275, experienceYears: 15, patientsCount: 3200,
      price: 1000, location: 'Al malki', clinicAddress: 'City Hospital',
      consultationFee: 150, availableDates: _dates, availableTimes: _times,
      workingHours: _workingHours,
    ),
    Doctor(
      id: '4', name: 'Dr. Olivia Martinez', specialty: 'dermatology',
      about: 'Treating skin, hair and nail diseases using the latest technology.',
      imageUrl: 'https://images.unsplash.com/photo-1595152772835-219674b2a8a6',
      rating: 4.9, reviewsCount: 410, experienceYears: 11, patientsCount: 2900,
      price: 400, location: 'Rukin Al Din', clinicAddress: 'Skin Care Clinic',
      consultationFee: 110, availableDates: _dates, availableTimes: _times,
      workingHours: _workingHours,
    ),
    Doctor(
      id: '5', name: 'Dr. David Miller', specialty: 'orthopedic',
      about: 'Orthopedic surgeon specializing in sports injuries and joint replacement.',
      imageUrl: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d',
      rating: 4.8, reviewsCount: 356, experienceYears: 18, patientsCount: 4100,
      price: 600, location: 'Dumar', clinicAddress: 'Orthopedic Center',
      consultationFee: 140, availableDates: _dates, availableTimes: _times,
      workingHours: _workingHours,
    ),
    Doctor(
      id: '6', name: 'Dr. Sophia Lee', specialty: 'pediatrics',
      about: 'Providing compassionate healthcare for infants, children and adolescents.',
      imageUrl: 'https://images.unsplash.com/photo-1651008376811-b90baee60c1f',
      rating: 5.0, reviewsCount: 520, experienceYears: 13, patientsCount: 5000,
      price: 500, location: 'Qasun', clinicAddress: 'Children Medical Center',
      consultationFee: 100, availableDates: _dates, availableTimes: _times,
      workingHours: _workingHours,
    ),
  ];
